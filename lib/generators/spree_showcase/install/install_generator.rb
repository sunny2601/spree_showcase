module SpreeShowcase
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file 'vendor/assets/javascripts/spree/frontend/all.js', "//= require jquery.flexslider\n"
      ...
      def add_stylesheets
        inject_into_file 'vendor/assets/stylesheets/spree/frontend/all.css', " *= require spree/showcase\n", :before => /\*\//, :verbose => true

        @source = "stylesheets/store/showcase.css.scss"
        @dest = "vendor/assets/stylesheets/spree/frontend/showcase.css.scss"
        if copy_file(@source, @dest)
